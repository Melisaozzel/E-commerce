 ...
 */
export declare function getFixedPosition({ container, element, anchor, initialX, initialY, vwMargin, vhMargin, xMargin, yMargin, width: widthType, preventOverlap, transformOrigin, disableSwapping, disableVHBounds, }: FixedPositionOptions): FixedPosition;
